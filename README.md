...
Especialista em dados com atuação em ambientes de missão crítica, combinando experiência sólida em bancos relacionais com práticas modernas de Engenharia de Dados, DataOps e automação.

Atuo na SEFAZ/SE com foco em modernização de plataformas analíticas, governança e performance de dados, além de docência em cursos de especialização em Engenharia de Dados e IA.
...
![Estatisticas do GitHub de Anderson](https://github-readme-stats-eight-theta.vercel.app/api?username=AndersonDeFaro&show_icons=true)
...
> "Transformando ambientes complexos em estruturas de dados ageis e resilientes."
